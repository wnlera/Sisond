...
let descs = [
    "должен быть Times New Roman, 14 Pt",
    "должны быть: левое - 3 см, правое - 1, верхнее и нижнее - 2 см",
    "должны быть выполнены слева сверху над таблицей в формате \"Таблица 1.1 - Название\"",
    "должны быть по центру под рисунком в формате \"Таблица 1.2 - Название\"",
    "должно быть автосодержание"
];
